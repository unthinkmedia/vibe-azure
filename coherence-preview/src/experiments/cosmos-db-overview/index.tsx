// @ts-nocheck
/**
 * Azure Cosmos DB Account Overview — main entry point
 *
 * RU/s consumption gauge, partition key heat map, global distribution map,
 * consistency level selector, and recent operations table.
 *
 * File structure:
 *   data.ts          — essentials, RU data, partitions, regions, consistency, ops
 *   styles.ts        — scoped CSS
 *   Navigation.tsx   — side nav component
 *   PageContent.tsx  — all overview sections
...
export default function CosmosDbOverview() {
  return (
    <>
        ...
        <div slot="main">
          <div style={{ padding: '8px 32px 0' }}>
            <CuiBreadcrumb label="Navigation" size="small">
              ...
              <CuiBreadcrumbItem href="#">Azure Cosmos DB</CuiBreadcrumbItem>
