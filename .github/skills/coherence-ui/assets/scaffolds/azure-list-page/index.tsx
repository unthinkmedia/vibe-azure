// @ts-nocheck
/**
 * Azure List Page — main entry point
 *
 ...
 *
 * File structure:
 *   data.ts          — list items, resource config, nav items, types
 *   styles.ts        — scoped CSS
 *   Navigation.tsx   — side nav component
 *   PageContent.tsx  — two-column list + detail layout (the unique part)
    ...
    <>
      <CuiAppFrame skipToMainText="Skip to main content">
        ...
        <div slot="main">
          ...
          {/* TODO: Customize title and suggestions for your resource */}
          <PageHeader
