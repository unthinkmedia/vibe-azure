// @ts-nocheck
/**
 * Azure Marketplace Browse — main entry point
 *
 * Full-width page with categories sidebar + two-column service/marketplace grid.
 * Matches the Azure portal "Create a resource" landing page pattern.
 *
 * File structure:
 *   data.ts          — types, categories, services, marketplace products
 *   styles.ts        — scoped CSS
 *   PageContent.tsx   — categories sidebar + two-column grid (the unique part)
