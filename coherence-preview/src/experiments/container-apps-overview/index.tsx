// @ts-nocheck
/**
 * Azure Container Apps Overview — main entry point
 *
 * Container App resource page with essentials panel, scaling metrics
 * with sparklines, revisions table, and ingress configuration.
 *
 * File structure:
 *   data.ts          — essentials, revisions, metrics, ingress config, nav items
 *   styles.ts        — scoped CSS
 *   Navigation.tsx   — side nav component
 *   PageContent.tsx  — essentials + metrics + revisions + ingress
...
export default function ContainerAppsOverview() {
  return (
    <>
        ...
        <div slot="main">
          <div style={{ padding: '8px 32px 0' }}>
            <CuiBreadcrumb label="Navigation" size="small">
              ...
              <CuiBreadcrumbItem href="#">Container Apps</CuiBreadcrumbItem>
