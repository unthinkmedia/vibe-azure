// @ts-nocheck
/**
 * Azure Kubernetes Service (AKS) Cluster Overview — main entry point
 *
 * AKS cluster resource page with certificate warning, cluster health summary,
 * node pool utilization bars, recent deployments table, and Copilot suggestions.
 *
 * File structure:
 *   data.ts          — cluster health, node pools, deployments, nav items
 *   styles.ts        — scoped CSS
 *   Navigation.tsx   — side nav component
 *   PageContent.tsx  — warning bar + health + node pools + deployments
...
export default function AKSClusterOverview() {
  return (
    <>
        ...
        <div slot="main">
          <div style={{ padding: '8px 32px 0' }}>
            <CuiBreadcrumb label="Navigation" size="small">
              ...
              <CuiBreadcrumbItem href="#">Kubernetes services</CuiBreadcrumbItem>
              <CuiBreadcrumbItem active current="page">{resourceName}</CuiBreadcrumbItem>
            </CuiBreadcrumb>
          </div>

          <PageHeader
            icon="https://api.iconify.design/fluent:window-shield-24-regular.svg"
            title={`${resourceName} | Overview`}
