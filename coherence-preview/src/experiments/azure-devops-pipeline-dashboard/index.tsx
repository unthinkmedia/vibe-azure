...
import { pageTitle, serviceName } from './data';
...
export default function AzureDevOpsPipelineDashboard() {
        ...
        <div slot="main" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
          <div className="apd-breadcrumb">
            <CuiBreadcrumb label="Navigation" size="small">
              ...
              <CuiBreadcrumbItem href="#">Azure DevOps Pipeline</CuiBreadcrumbItem>
            </CuiBreadcrumb>
          </div>

          <PageHeader
            icon="https://api.iconify.design/fluent:pipeline-24-regular.svg"
            title={<><strong>{serviceName}</strong> | {pageTitle}</>}
            subtitle="Contoso Engineering (Project Falcon · 42 active pipelines)"
          ...
          <div className="apd-body">
            <div className={`apd-sidebar ${sidebarOpen ? '' : 'collapsed'}`}>
              <Navigation />
            </div>
