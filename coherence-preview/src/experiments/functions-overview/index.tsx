// @ts-nocheck
/**
 * Azure Functions Overview — main entry point
 *
 * Function App resource page with essentials panel, monitoring metrics cards
 * with sparklines, and a functions list table.
 *
 * File structure:
 *   data.ts          — essentials data, metrics, functions list, nav items
        ...
        <div slot="main">
          <div style={{ padding: '8px 32px 0' }}>
            <CuiBreadcrumb label="Navigation" size="small">
              ...
              <CuiBreadcrumbItem href="#">Function App</CuiBreadcrumbItem>
