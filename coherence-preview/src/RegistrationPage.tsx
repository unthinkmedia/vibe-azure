    ...
    <CuiAppFrame skipToMainText="Skip to main content">
      <CuiHeader slot="header">
        <CuiButton slot="title" appearance="transparent">
          <span className="font-base400">Registration Portal</span>
        </CuiButton>
      </CuiHeader>

      <CuiDrawer slot="navigation" inline open position="start" breakpoint="686px">
        <CuiSideNav>
          <CuiNavHeading>Account</CuiNavHeading>
          <CuiNavItem label="Register" href="#" selected>
            <CuiIcon slot="icon" name="person" />
          </CuiNavItem>
          <CuiNavItem label="Sign In" href="#">
            <CuiIcon slot="icon" name="lock-closed" />
          </CuiNavItem>
        </CuiSideNav>
      </CuiDrawer>

      <div slot="main" style={{ padding: '40px 72px', maxWidth: 720 }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <h2
            className="font-base500 font-semi-bold"
