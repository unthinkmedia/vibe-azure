// @ts-nocheck
/**
 * Azure Storage Account Overview — main entry point
 *
 * Storage account overview page with usage donut chart, cost-to-date card,
 * and access keys section with copy-to-clipboard and 90-day age warning.
 *
 * File structure:
 *   data.ts          — essentials, usage segments, cost data, access keys, nav items
 *   styles.ts        — scoped CSS
 *   Navigation.tsx   — side nav component
 *   PageContent.tsx  — essentials + donut chart + cost card + access keys
...
export default function StorageAccountOverview() {
  return (
    <>
        ...
        <div slot="main">
          <div style={{ padding: '8px 32px 0' }}>
            <CuiBreadcrumb label="Navigation" size="small">
              ...
              <CuiBreadcrumbItem href="#">Storage accounts</CuiBreadcrumbItem>
