// @ts-nocheck
/**
 * Azure SQL Database Overview — main entry point
 *
 * SQL Database overview page with DTU usage gauge, active connections count,
 * geo-replication status cards, and recent audit log table.
 *
 * File structure:
 *   data.ts          — essentials, DTU data, connections, geo-replicas, audit log, nav items
 *   styles.ts        — scoped CSS
 *   Navigation.tsx   — side nav component
 *   PageContent.tsx  — essentials + DTU gauge + connections + geo-replication + audit log
...
export default function SqlDatabaseOverview() {
  return (
    <>
        ...
        <div slot="main">
          <div style={{ padding: '8px 32px 0' }}>
            <CuiBreadcrumb label="Navigation" size="small">
              ...
              <CuiBreadcrumbItem href="#">SQL databases</CuiBreadcrumbItem>
