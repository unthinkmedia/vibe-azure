// @ts-nocheck
/**
 * Azure Key Vault Overview Dashboard — main entry point
 *
 * Secrets expiration timeline, certificate health dashboard,
 * access policy summary cards, and sensitive operations log.
 */
import {
  CuiAppFrame,
  CuiAvatar,
...
export default function KeyVaultOverview() {
  return (
    <>
      <CuiAppFrame skipToMainText="Skip to main content">
        ...
        <div slot="main">
          ...
          <PageHeader
            icon="https://api.iconify.design/fluent:key-multiple-24-regular.svg"
            title={resourceName}
